  ...
  <el-main>
    <div class="main-content">
      <el-form
        ...
        label-width="120px"
      >
        <el-form-item label="休假人员姓名" prop="name">
          <el-input
        ...
        <el-form-item label="休假事由" prop="title">
          <el-input v-model="station.title" style="width: 400px"></el-input>
        </el-form-item>
        <el-form-item label="休假地点" prop="home">
          <el-input
  ...
  data() {
    return {
      ...
      rules: {
        ...
        home: [{ required: true, message: '请输入休假地点', trigger: 'blur' }],
        title: [{ required: true, message: '请输入休假事由', trigger: 'blur' }],
  ...
  methods: {
    ...
    async addHandle() {
      ...
      if (res && res.code === '200') {
        ...
        this.$router.push('/goout/vacation')
      } else {
        this.$message({
          message: '添加失败',
          type: 'error'
